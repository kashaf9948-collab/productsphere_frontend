...
class AppRoutes {
  ...
  static final List<GetPage<dynamic>> pages = [
    ...
    GetPage(
      name: buyerNegotiations,
      page: () => const NegotiationsListScreen(),
      middlewares: [AuthMiddleware()],
    ),
    GetPage(
      name: wholesalerNegotiations,
      page: () => const WholesalerNegotiationsScreen(),
      middlewares: [AuthMiddleware()],
    ),
    GetPage(
      name: adminNegotiations,
      page: () => const AdminNegotiationsScreen(),
      middlewares: [AuthMiddleware()],
    ),
    GetPage(
      name: profile,
