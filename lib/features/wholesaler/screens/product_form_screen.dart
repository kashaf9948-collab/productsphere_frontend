...
class _ProductFormScreenState extends State<ProductFormScreen> {
  ...
  Future<void> _loadWholesalers() async {
    ...
    try {
      final list = await BuyerService.fetchApprovedWholesalers();
      setState(() {
        _wholesalers = list;
  ...
  Future<void> _submitForm() async {
    ...
    try {
      if (_isEditMode && _productId != null) {
        result = await WholesalerService.updateProduct(_productId!, productMap);
      } else {
        result = await WholesalerService.publishProduct(productMap);
      }
    } catch (e) {
