...
class AdminService {
  ...
  static Future<List<dynamic>> fetchPendingWholesalers() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/admin/pending-wholesalers'), headers: _headers);
      final data = json.decode(response.body);
      if (response.statusCode == 200 && data['success'] == true) return data['data'] ?? [];
      return [];
    } catch (e) {
      return [];
    }
  ...
  static Future<Map<String, dynamic>> updateBusinessStatus(int userId, String status) async {
    try {
      ...
      final data = json.decode(response.body);
      if (response.statusCode == 200 && data['success'] == true) return {'success': true, 'message': data['message']};
  ...
  static Future<Map<String, dynamic>> deleteProduct(int productId) async {
    try {
      final response = await http.delete(Uri.parse('$baseUrl/admin/products/$productId'), headers: _headers);
      final data = json.decode(response.body);
      if (response.statusCode == 200 && data['success'] == true) return {'success': true, 'message': data['message']};
  ...
  static Future<List<dynamic>> fetchAdminBids() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/negotiations'), headers: _headers);
      final data = json.decode(response.body);
      if (response.statusCode == 200 && data['success'] == true) return data['data'] ?? [];
      return [];
    } catch (e) {
  ...
  static Future<List<dynamic>> fetchAdminBuyers() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/admin/buyers'), headers: _headers);
      final data = json.decode(response.body);
      if (response.statusCode == 200 && data['success'] == true) return data['data'] ?? [];
      return [];
    } catch (e) {
  ...
  static Future<List<dynamic>> fetchAdminOrders() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/admin/orders'), headers: _headers);
      final data = json.decode(response.body);
      if (response.statusCode == 200 && data['success'] == true) return data['data'] ?? [];
      return [];
    } catch (e) {
  ...
  static Future<List<dynamic>> fetchAdminNotificationsAudit() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/notifications/admin'), headers: _headers);
      final data = json.decode(response.body);
      if (response.statusCode == 200 && data['success'] == true) return data['data'] ?? [];
      return [];
    } catch (e) {
