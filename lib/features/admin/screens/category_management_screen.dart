...
class _CategoryManagementScreenState extends State<CategoryManagementScreen> {
  ...
  Future<void> _fetchCategories() async {
    ...
    try {
      final data = await BuyerService.fetchCategories();
      setState(() {
        _categories = data;
        _isLoading = false;
      });
  ...
  Future<void> _saveCategory({int? id, required String name, String? description}) async {
    ...
    if (id == null) {
      result = await AdminService.createCategory(name, description);
    } else {
      result = await AdminService.updateCategory(id, name, description);
    }
  ...
  Future<void> _deleteCategory(int id, String name) async {
    ...
    final result = await AdminService.deleteCategory(id);
