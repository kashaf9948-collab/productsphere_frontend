...
class _AdminSettingsScreenState extends State<AdminSettingsScreen>
  ...
  Future<void> _fetchSettings() async {
    ...
    final result = await AdminService.fetchSystemSettings();
  ...
  Future<void> _savePlatformSettings() async {
    ...
    final result = await AdminService.saveSystemSettings({
  ...
  Future<void> _saveAccountSettings() async {
    ...
    // Update profile name
    if (name.isNotEmpty) {
      final profileResult = await BuyerService.updateProfile(name: name);
    ...
    if (newPass.isNotEmpty) {
      final passResult = await BuyerService.changePassword(
